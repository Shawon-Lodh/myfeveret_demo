class TrendingProductsModel {
  ...
  List<TrendingProductsModel> allTrendingProducts;
  ...
  TrendingProductsModel.withError(String errorMessage) {
    error = errorMessage;
  }

  TrendingProductsModel.makeListAllTrendingProducts(var jsonResponse) {
    allTrendingProducts = new List<TrendingProductsModel>();
    jsonResponse.forEach((insideJsonResponse) {
      insideJsonResponse.forEach((value){
        allTrendingProducts.add(new TrendingProductsModel.fromJson(value));
      });
    });
  }
